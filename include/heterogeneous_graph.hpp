...
/**
 * @class UnweightedHeteroDigraph
 * @brief Represents a weighted graph data structure.
 * 
 * @note This UnweightedHeteroDigraph class is indexed as 0-origin and allowed to have self-loops.
 * The UnweightedHeteroDigraph class provides a way to represent a weighted graph using an adjacency list.
