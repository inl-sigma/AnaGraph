...
TEST(PageRankTest, TestDirectedPageRank) {
    ...
    EXPECT_NEAR(pr[0], 0.2464482545465788, 1e-3);
    EXPECT_NEAR(pr[1], 0.08770594687045946, 1e-3);
    EXPECT_NEAR(pr[2], 0.0749234303673495, 1e-3);
    EXPECT_NEAR(pr[3], 0.027793521975148276, 1e-3);
    EXPECT_NEAR(pr[4], 0.02520115046292283, 1e-3);
    EXPECT_NEAR(pr[5], 0.03154958747530574, 1e-3);
    EXPECT_NEAR(pr[6], 0.021286383043794738, 1e-3);
    EXPECT_NEAR(pr[7], 0.014937946031411825, 1e-3);
    EXPECT_NEAR(pr[8], 0.02407770077491794, 1e-3);
